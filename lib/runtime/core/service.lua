...
function ServiceManager.__Lunar_Internal__Init__(instance, ConsoleService, FileSystemService, TimeService, ErrorService, TaskService, JSONService, LMathService)
  Instance = instance
